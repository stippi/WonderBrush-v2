...
#ifndef AGG_SPAN_IMAGE_RESAMPLE_RGBA_CONV_INCLUDED
#define AGG_SPAN_IMAGE_RESAMPLE_RGBA_CONV_INCLUDED
...
namespace agg
{
    ...
    //==============================================span_image_resample_rgba_conv
    template<class ColorT,
             class Order, 
             class Interpolator, 
             class Allocator = span_allocator<ColorT> >
    class span_image_resample_rgba_conv : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_rgba_conv(alloc_type& alloc) : 
            base_type(alloc),
			m_opacity(255)
        {}
