...
// ScaledWidth
double
TransformBox::ScaledWidth() const
{
...
// ScaledHeight
double
TransformBox::ScaledHeight() const
{
...
{
//printf("TransformBox::MouseMoved()\n");
	fMousePos = where;
...
DragState*
TransformBox::_DragStateFor(BPoint where)
{
