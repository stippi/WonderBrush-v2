...
#ifndef SIMPLE_SELECT_STATE_H
#define SIMPLE_SELECT_STATE_H
...
class SimpleSelectState : public CanvasViewState {
 public:
								SimpleSelectState(CanvasView* parent);
	virtual						~SimpleSelectState();
 ...
 private:
	...
	friend	class				ChangeSelectRectAction;
	...
	enum {
		...
		DRAGGING_ALL,
			...
			bool				fSelectAllLayers;
};

#endif	// SIMPLE_SELECT_STATE_H
